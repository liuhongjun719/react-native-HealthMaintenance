...
@interface MedicatedViewController ()

@end

@implementation MedicatedViewController
...
- (void)viewDidLoad {
  ...
  self.view = [[RNRequest alloc] getRootView:@{
                                               @"url":@"http://www.idwoo.net/api/zyys/get_category_posts/?id=708&page=0&dev=1",
                                               @"type":@"1"
