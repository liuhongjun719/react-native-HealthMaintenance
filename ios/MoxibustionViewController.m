...
@interface MoxibustionViewController ()

@end

@implementation MoxibustionViewController
...
- (void)viewDidLoad {
  ...
  self.view = [[RNRequest alloc] getRootView:@{
                                               @"url":@"http://www.idwoo.net/api/zyys/get_category_posts/?id=705&page=0&dev=1",
                                               @"type":@"1"
